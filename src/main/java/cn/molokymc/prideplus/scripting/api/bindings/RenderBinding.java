...
import cn.molokymc.prideplus.scripting.api.objects.ScriptFramebuffer;
import cn.molokymc.prideplus.scripting.api.objects.ScriptShaderUtil;
...
public class RenderBinding implements Utils {
    ...
    private AbstractFontRenderer getFont() {
        return HUDMod.customFont.isEnabled() ? rubikFont20 : mc.fontRendererObj;
    }
