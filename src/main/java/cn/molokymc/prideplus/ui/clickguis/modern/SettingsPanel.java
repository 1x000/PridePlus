...
import cn.molokymc.prideplus.ui.GuiEvents;
...
import cn.molokymc.prideplus.utils.misc.StringUtils;
    ...
    public SettingsPanel(Module module) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof StringSetting) {
                ...
                TextField textField = new TextField(rubikFont18);
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof BooleanSetting) {
                ...
                rubikFont16.drawString(setting.name, x + 13, settingY + rubikFont16.getMiddleOfBox(8), -1);
            ...
            if (setting instanceof ModeSetting) {
                ...
                float stringWidth = (float) rubikFont16.getStringWidth(StringUtils.getLongestModeName(modeSetting.modes));
                ...
                float nameWidth = rubikFont16.getStringWidth(modeSetting.name);
                float stringX = x + 13;
                if (nameWidth > (boxX - stringX)) {
                    rubikFont16.drawWrappedText(modeSetting.name, stringX, settingY - (rubikFont16.getMiddleOfBox(12) / 2), -1, boxX - stringX, 2);
                    //    rubikFont16.drawString(modeSetting.name, stringX + (boxX - stringX) / 2f, settingY + rubikFont16.getMiddleOfBox(8), -1);
                } else {
                    rubikFont16.drawString(modeSetting.name, x + 13, settingY + 2, -1);
                }
                ...
                rubikFont16.drawCenteredString(modeSetting.getMode(), modeX, settingY + rubikFont16.getMiddleOfBox(10), -1);
                ...
                for (String mode : modeSetting.modes) {
                    if (!mode.equalsIgnoreCase(modeSetting.getMode())) {
                        ...
                        rubikFont16.drawCenteredString(mode, modeX, (float) (settingY + 2 + ((modeCount * 15) * animation.getOutput().floatValue())),
            ...
            if (setting instanceof ColorSetting) {
                ...
                rubikFont16.drawCenteredString(colorSetting.name, (x + 13) + 115 / 2f, settingY + 3, -1);
                ...
                GL11.glEnable(GL11.GL_BLEND);
                mc.getTextureManager().bindTexture(new ResourceLocation("stable/booleanslider1.png"));
                ...
                rubikFont14.drawString("Rainbow: ", gradientX, gradientY + gradientHeight + 14, -1);

                String text = colorSetting.isRainbow() ? "Enabled" : "Disabled";
                float textX = gradientX + rubikFont14.getStringWidth("Rainbow: ") + 4;
                float textY = gradientY + gradientHeight + 13;

                boolean hoveringRound = HoveringUtil.isHovering(textX, textY, rubikFont14.getStringWidth(text) + 4, rubikFont14.getHeight() + 2, mouseX, mouseY);
                ...
                RoundedUtil.drawRound(textX, textY, rubikFont14.getStringWidth(text) + 4, rubikFont14.getHeight() + 2, 3,
                        hoveringRound ? roundColor.brighter() : roundColor);

                rubikFont14.drawCenteredString(text, textX + (rubikFont14.getStringWidth(text) + 4) / 2f,
                        textY + rubikFont14.getMiddleOfBox(rubikFont14.getHeight() + 2), -1);
            ...
            if (setting instanceof NumberSetting) {
                ...
                rubikFont16.drawString(setting.name, x + 13, settingY + 2, -1);
                ...
                rubikFont16.drawString(value, x + 120 - rubikFont16.getStringWidth(value), settingY + 2, -1);
            ...
            if (setting instanceof StringSetting) {
                ...
                rubikFont16.drawString(setting.name, x + 16, settingY + 1, -1);
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                rubikFont16.drawCenteredString(multiBoolSetting.name, x + 70.5f, settingY - 3 + 16 / 2f - rubikFont16.getHeight() / 2f, -1);
                ...
                for (BooleanSetting booleanSetting : multiBoolSetting.getBoolSettings()) {
                    ...
                    boolean isHoveringBool = animation.getDirection().equals(Direction.FORWARDS) &&
                            HoveringUtil.isHovering(x + 17, settingY + (boolCount * 15),
                                    (float) rubikFont16.getStringWidth(booleanSetting.name) + 13, 11, mouseX, mouseY);
                    ...
                    GlStateManager.color(1, 1, 1, 1);
                    rubikFont16.drawString(booleanSetting.name, x + 28, (float) (settingY + 2 + ((boolCount * 15) * animation.getOutput().floatValue())),
                            ColorUtil.interpolateColor(new Color(40, 40, 40, 10), new Color(colorInterpolate), (float) animation.getOutput().floatValue()));
                    boolCount++;
