...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(rubikFont14);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        FontManager.edit14.drawString(colorSetting.name, x + 5, y + FontManager.edit14.getMiddleOfBox(realHeight)+4, new Color(0,0,0));
        ...
        FontManager.edit12.drawCenteredStringWithShadow(text, colorX + colorWidth / 2f,
                colorY + FontManager.edit12.getMiddleOfBox(colorHeight)+2,
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                FontManager.edit14.drawString("Hex", gradientX, newYVal + FontManager.edit14.getMiddleOfBox(heightLeft)+4, whiteColor);
                ...
                if (!hexField.isFocused()) {
                    ...
                    try {
                        ...
                        FontManager.edit12.drawString("Invalid Hex Code", hexField.getXPosition() - .5f, newYVal - (FontManager.edit12.getHeight() - .5f+2),
            ...
            if (!rainbowAnimation.isDone() || rainbowAnimation.finished(Direction.FORWARDS)) {
                Color textColor = ColorUtil.applyOpacity(Color.BLACK, colorAlpha * rainbowAnim);
                if (rainbowSettings != null) {
                    ...
                    for (NumberComponent numberComponent : rainbowSettings) {
                        ...
                        numberComponent.textColor = new Color(255,255,255);
