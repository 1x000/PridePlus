...
public class GuiProtocolSelector extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        if (button.id == 1) {
            ...
            try {
                ...
                setStatus(EnumChatFormatting.GREEN + "Dump created and copied to clipboard");
            } catch (InterruptedException | ExecutionException e) {
                setStatus(EnumChatFormatting.RED + "Failed to create dump: " + e.getMessage());
            }
        } else {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, EnumChatFormatting.GOLD + "ViaForgeMCP", width / 4, 3, 16777215);
        GL11.glPopMatrix();
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int index, int x, int y, int slotHeight, int mouseX, int mouseY) {
            ...
            if (targetVersion == version) {
                color = GuiProtocolSelector.this.simple ? EnumChatFormatting.GOLD.toString() : EnumChatFormatting.GREEN.toString();
            } else {
                color = GuiProtocolSelector.this.simple ? EnumChatFormatting.WHITE.toString() : EnumChatFormatting.DARK_RED.toString();
            }
