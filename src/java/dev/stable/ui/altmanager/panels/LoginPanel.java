...
import dev.stable.ui.sidegui.utils.ActionButton;
...
import dev.stable.utils.text.RandomStringGenerator;
...
public class LoginPanel extends Panel {
    ...
    public LoginPanel() {
        ...
        textFields.add(new TextField(Utils.rubikFont20));
        textFields.add(new TextField(Utils.rubikFont20));
    }
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        setHeight(180);
        Utils.tenacityBoldFont32.drawCenteredString("Login", getX() + getWidth() / 2f, getY() + 3, ColorUtil.applyOpacity(-1, .75f));
        ...
        for (ActionButton actionButton : actionButtons) {
            ...
            actionButton.setFont(Utils.tenacityBoldFont22);
        ...
        Utils.mc.getTextureManager().bindTexture(new ResourceLocation("Pride/mc.png"));
        ...
        Utils.tenacityBoldFont26.drawString("Microsoft Login", microX + 10, microsoftY + 4, -1);

        Utils.rubikFont16.drawString("Login to your migrated account", microX + 10, microsoftY + 23, -1);
