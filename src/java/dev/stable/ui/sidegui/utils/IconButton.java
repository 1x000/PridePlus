...
public class IconButton implements Screen {
    ...
    private CustomFont iconFont = Utils.iconFont16;
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        boolean hovering = SideGUI.isHovering(x - 3, y - 3, Utils.iconFont16.getStringWidth(icon) + 6, Utils.iconFont16.getHeight() + 6, mouseX, mouseY);
