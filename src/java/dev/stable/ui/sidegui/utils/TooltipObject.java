...
import dev.stable.utils.tuples.mutable.MutablePair;
...
public class TooltipObject implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (tooltip.contains("\n")) {
            ...
            MutablePair<Float, Float> whPair = Utils.rubikFont14.drawNewLineText(tooltip, x + 2, y + 2, ColorUtil.applyOpacity(-1, fadeAnim), 3);

            float additionalHeight = 0;
            if (additionalInformation != null) {
                additionalHeight = Utils.rubikFont14.drawWrappedText(additionalInformation, x + 2,
            ...
            width = Utils.rubikFont14.getStringWidth(tooltip) + 4;
            height = Utils.rubikFont14.getHeight() + 2;
            ...
            Utils.rubikFont14.drawCenteredString(tooltip, x + width / 2f, y + Utils.rubikFont14.getMiddleOfBox(height), ColorUtil.applyOpacity(-1, fadeAnim));
