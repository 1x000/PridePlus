package dev.stable.scripting.api;
...
import dev.stable.scripting.api.bindings.*;
...
public class Script implements Utils {
    ...
    private String name,cname, author, description;
    ...
    public Script(File file) throws ScriptException {
        ...
        registerModule(name,cname, description, author, file);
    ...
    private void registerModule(String name,String cname, String description, String author, File file) {
        scriptModule = new ScriptModule(name,cname, description, eventHashMap, author, file);
