...
import dev.stable.utils.time.TimeUtil;
...
public class RenderUtil implements Utils {
    ...
    public static void drawNewRect(double x, double y, double x1, double y1, double size , float color1, float color2 , float color3) {
        dev.stable.utils.render.RenderUtil.rectangleBordered(x, y, x1 + size, y1 + size, 0.5d, ColorUtils.getColor(90), ColorUtils.getColor(0));
        dev.stable.utils.render.RenderUtil.rectangleBordered(x + 1.0f, y + 1.0f, (x1 + size - 1.0f), y1 + size - 1.0f, 1.0, ColorUtils.getColor(90),
                ColorUtils.getColor(61));
        dev.stable.utils.render.RenderUtil.rectangleBordered(x + 2.5, y + 2.5, (x1 + size) - 2.5, (y1 + size) - 2.5, 0.5, ColorUtils.getColor(61),
                ColorUtils.getColor(0));
        double width = x1 - x;
        dev.stable.utils.render.RenderUtil.drawGradientSideways(x + 3, y + 3, x + (width / 3), y + 4, new Color(81, 149, 219, 255).getRGB(), new Color(180, 49, 218, 255).getRGB());
        dev.stable.utils.render.RenderUtil.drawGradientSideways(x + (width / 3), y + 3, x + ((width / 3) * 2), y + 4, new Color(180, 49, 218, 255).getRGB(), new Color(236, 93, 128, 255).getRGB());
        dev.stable.utils.render.RenderUtil.drawGradientSideways(x + ((width / 3) * 2), y + 3, x + ((width / 3) * 3) - 1, y + 4, new Color(236, 93, 128, 255).getRGB(), new Color(167, 171, 90, 255).getRGB());
    }
