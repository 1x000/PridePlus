...
public class ColorUtil {
    ...
    public static Color getGradient(Color color1, Color color2, double scale) {
        ...
        return new Color((int) (HUDMod.getClientColors().getFirst().getRed() + (HUDMod.getClientColors().getSecond().getRed() - HUDMod.getClientColors().getFirst().getRed()) * scale),
                (int) (HUDMod.getClientColors().getFirst().getGreen() + (HUDMod.getClientColors().getSecond().getGreen() - HUDMod.getClientColors().getFirst().getGreen()) * scale),
                (int) (HUDMod.getClientColors().getFirst().getBlue() + (HUDMod.getClientColors().getSecond().getBlue() - HUDMod.getClientColors().getFirst().getBlue()) * scale));
    }
    public static Color getColor(Color color1, Color color2, long ms, int offset) {
        ...
        return getGradient(HUDMod.getClientColors().getFirst(), HUDMod.getClientColors().getSecond(), finalScale);
    }
    public static Color intToColor(int color) {
        Color c1 = new Color(color);
        return new Color(c1.getRed(), c1.getGreen(), c1.getBlue(), (color >> 24) & 0xFF);
    }
    ...
    public static Color interpolateColorHue(Color color1, Color color2, float amount) {
        ...
        return ColorUtil.applyOpacity(resultColor, MathUtils.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount) / 255f);
    }
