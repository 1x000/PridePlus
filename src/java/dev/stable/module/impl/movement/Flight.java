...
import dev.stable.event.impl.player.MoveEvent;
...
import dev.stable.utils.player.DamageUtils;
...
public final class Flight extends Module {
    ...
    public Flight() {
        super("Flight", "老铁一字飞",Category.MOVEMENT, "Makes you hover in the air");
