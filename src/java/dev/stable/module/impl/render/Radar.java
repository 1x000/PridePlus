...
public class Radar extends Module {
    ...
    public void onRender2DEvent(Render2DEvent e) {
        ...
        if (bar.isEnabled())
            dev.stable.utils.render.RenderUtil.drawGradientSideways(x, -1 + y, size -50 + x + 51, y, HUDMod.getClientColors().getFirst().getRGB(), HUDMod.getClientColors().getSecond().getRGB());
        if (bar.isEnabled())
