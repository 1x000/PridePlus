package dev.stable.module.impl.render.mobends;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import com.google.common.collect.Maps;
import dev.stable.module.impl.render.mobends.animation.Animation;
import dev.stable.module.impl.render.mobends.client.renderer.entity.RenderBendsPlayer;
import dev.stable.module.impl.render.mobends.client.renderer.entity.RenderBendsSpider;
import dev.stable.module.impl.render.mobends.client.renderer.entity.RenderBendsZombie;
import dev.stable.module.impl.render.mobends.util.BendsLogger;
...
public class AnimatedEntity {
	...
	public static void register() {
		...
		registerEntity(new AnimatedEntity("player","Player",Minecraft.getMinecraft().thePlayer,EntityPlayer.class,new RenderBendsPlayer(Minecraft.getMinecraft().getRenderManager())).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Stand()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Walk()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Sneak()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Sprint()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Jump()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Attack()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Swimming()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Bow()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Riding()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Mining()).
			add(new dev.stable.module.impl.render.mobends.animation.player.Animation_Axe()));
		registerEntity(new AnimatedEntity("zombie","Zombie",new EntityZombie(null),EntityZombie.class,new RenderBendsZombie(Minecraft.getMinecraft().getRenderManager())).
			add(new dev.stable.module.impl.render.mobends.animation.zombie.Animation_Stand()).
			add(new dev.stable.module.impl.render.mobends.animation.zombie.Animation_Walk()));
		registerEntity(new AnimatedEntity("spider","Spider",new EntitySpider(null),EntitySpider.class,new RenderBendsSpider(Minecraft.getMinecraft().getRenderManager())).
			add(new dev.stable.module.impl.render.mobends.animation.spider.Animation_OnGround()).
			add(new dev.stable.module.impl.render.mobends.animation.spider.Animation_Jump()).
			add(new dev.stable.module.impl.render.mobends.animation.spider.Animation_WallClimb()));
