...
import dev.stable.event.impl.game.*;
import dev.stable.event.impl.player.BlockEvent;
import dev.stable.event.impl.player.BlockPlaceableEvent;
import dev.stable.event.impl.player.ClickEvent;
import dev.stable.event.impl.player.ClickEventRight;
import dev.stable.module.impl.render.ClickGUIMod;
import dev.stable.module.api.ProtectedLaunch;
import dev.stable.ui.clickguis.dropdown.DropdownClickGUI;
import dev.stable.ui.mainmenu.GuiStart;
import dev.stable.utils.font.FontUtil;
import dev.stable.utils.render.RenderUtil;
import dev.stable.viamcp.fixes.AttackOrder;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        SplashScreen.setProgress(1,"SplashScreen");
        this.skinManager = new SkinManager(this.renderEngine, new File(this.fileAssets, "skins"), this.sessionService);
        this.saveLoader = new AnvilSaveConverter(new File(this.mcDataDir, "saves"));
        this.mcSoundHandler = new SoundHandler(this.mcResourceManager, this.gameSettings);
        SplashScreen.setProgress(2,"ResourceManager");
        ...
        SplashScreen.setProgress(3,"fontRender");
        ...
        SplashScreen.setProgress(4,"mouseHelper");
        ...
        SplashScreen.setProgress(5,"ModuleManager");
        ...
        SplashScreen.setProgress(6,"GlStateManager");
        ...
        SplashScreen.setProgress(10,"GuiMainMenu");
        this.displayGuiScreen(new GuiStart());
