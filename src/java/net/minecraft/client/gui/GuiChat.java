...
import dev.stable.module.impl.render.ArrayListMod;
...
public class GuiChat extends GuiScreen {
    ...
    public static Animation openingAnimation = new DecelerateAnimation(250, 1, Direction.BACKWARDS);
    ...
    public void initGui() {
        ...
        openingAnimation = new EaseBackIn(175, 1,(float)1.5);


        resetButtonHover = new EaseBackIn(250, 1,(float)1.5);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
       ...
       FontDrawer fr = FontManager.small;
