...
public class ModelBiped extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (Dab.getInstance.isEnabled()
                && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
        ...
        if (Loli.getInstance.isEnabled()
        && entityIn.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
            this.bipedRightArm.rotateAngleX = 0.5F;
            this.bipedRightArm.rotateAngleY = -2.25F;
            this.bipedLeftArm.rotateAngleX = 0.5F;
            this.bipedLeftArm.rotateAngleY = 2.25F;
            this.aimedBow = true;
            this.isChild = true;
        }
