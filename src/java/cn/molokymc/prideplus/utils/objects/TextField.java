...
public class TextField extends Gui {
    ...
    private Color focusedTextColor = new Color(0, 0, 0);
    private Color unfocusedTextColor = new Color(0, 0, 0);
    /**
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (text.length() > 0) {
                ...
                j1 = this.font.drawString(s1, xPos, yPos, textColorWithAlpha.getRGB()) + .5f;
            }
            ...
            if (text.length() > 0 && cursorInBounds && cursorPos < text.length()) {
                j1 = this.font.drawString(text.substring(cursorPos), j1 + 2f, yPos, new Color(0,0,0).getRGB());
            }
