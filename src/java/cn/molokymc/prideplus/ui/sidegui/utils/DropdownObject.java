    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || opened) {
            ...
            for (String option : options) {
                ...
                Utils.rubikFont18.drawString(option, getX() + 5, dropdownY + seperation + Utils.rubikFont18.getMiddleOfBox(getHeight()),
        ...
        Utils.rubikFont18.drawString("§l" + name + ":§r " + selection, getX() + 4, getY() + Utils.rubikFont18.getMiddleOfBox(getHeight()), textColor);


        float iconX = getX() + getWidth() - 10;
        float iconY = getY() + Utils.iconFont16.getMiddleOfBox(getHeight());

        RenderUtil.rotateStart(iconX, iconY, Utils.iconFont20.getStringWidth(FontUtil.DROPDOWN_ARROW), Utils.iconFont20.getHeight(), 180 * openAnimation.getOutput().floatValue());
        Utils.iconFont20.drawString(FontUtil.DROPDOWN_ARROW, getX() + getWidth() - 10, getY() + Utils.iconFont20.getMiddleOfBox(getHeight()) + 1, textColor);
