package cn.molokymc.prideplus.ui.sidegui.panels.infopanel;
...
public class InfoButton implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || openAnimation.finished(Direction.FORWARDS)) {
            ...
            List<String> lines = rubikFont16.getWrappedLines(answer, x + 5, (width - 5), heightIncrement);
            int spacing = 3;
            float totalAnswerHeight = (lines.size() * (rubikFont16.getHeight() + heightIncrement)) + 4;
            ...
            for (String line : lines) {
                rubikFont16.drawString(line, x + 3, answerY + 3.5f, textColor);
                answerY += rubikFont16.getHeight() + heightIncrement;
            }
