            ...
            for (double xSearch = 0.5 - xzRV / 2; xSearch <= 0.5 + xzRV / 2; xSearch += xzSSV) {
                for (double ySearch = 0.5 - yRV / 2; ySearch <= 0.5 + yRV / 2; ySearch += ySSV) {
                    for (double zSearch = 0.5 - xzRV / 2; zSearch <= 0.5 + xzRV / 2; zSearch += xzSSV) {
                        ...
                        final Vec3 rotationVector = new Vec3(cn.molokymc.prideplus.utils.movementfix.Rise.RotationUtils.getVectorForRotation(rotation).xCoord, cn.molokymc.prideplus.utils.movementfix.Rise.RotationUtils.getVectorForRotation(rotation).yCoord, cn.molokymc.prideplus.utils.movementfix.Rise.RotationUtils.getVectorForRotation(rotation).zCoord);
                        ...
                        if (placeRotation == null || cn.molokymc.prideplus.utils.movementfix.Rise.RotationUtils.getRotationDifference(rotation) < cn.molokymc.prideplus.utils.movementfix.Rise.RotationUtils.getRotationDifference(placeRotation.getRotation()))
